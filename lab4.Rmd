...
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_pengzh01.git>
...
[**https://pengzh313.github.io/dsci_521_lab4_pengzh01/**](https://pengzh313.github.io/dsci_521_lab4_pengzh01/)
...
```{r variance-hide_code, echo=FALSE}
...
```{r variance-add_comment, echo=FALSE, comment="The variance is"}
variance(c(10, 20, 30, 40))
...
<https://github.com/pengzh313/dsci_521_lab4_pengzh01.git>
...
The document with name of "basic_R_operations".
...
After clicking the '.md' file in the github, it has a view similar as a html file because a temporary html file was created for preview in the github.
